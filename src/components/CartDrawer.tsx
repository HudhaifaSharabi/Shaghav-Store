      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
          ...
          <div className="flex items-center gap-4">
            {cart.length > 0 && (
              <span className="font-shaghafArabic text-[10px] tracking-[0.2em] text-white/25">
          ...
          {cart.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center gap-6 px-8 text-center">
              ...
              <div>
                ...
                <p className="font-shaghafArabic text-[11px] text-white/15 tracking-[0.2em]">
              ...
              <Link
                href="/products"
                onClick={onClose}
                className="font-shaghafArabic text-[11px] tracking-[0.25em] text-[#D4AF37]/50 border border-[#D4AF37]/25 px-6 py-3 hover:border-[#D4AF37]/60 hover:text-[#D4AF37]/80 transition-all duration-500"
              >
                اكتشفي المتجر
              </Link>
            </div>
                ...
                return (
                  <li key={item.cartId} className="py-6 flex gap-4">
                    ...
                    <div className="relative flex-shrink-0 w-20 aspect-[3/4] overflow-hidden bg-white/[0.03]">
                      ...
                      {isOneOfOne && (
                        <div className="absolute bottom-0 left-0 right-0 bg-[#4B1E28]/80 py-0.5 text-center">
                          <span className="font-shaghafArabic text-[8px] tracking-[0.15em] text-[#D4AF37]/80">١/١</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex-1 flex flex-col min-w-0">
                      ...
                      <p className="font-shaghafArabic text-[11px] text-[#C87D8A]/60 tracking-[0.05em] mb-3">
                        اللون: {item.color} · المقاس: {item.size}
                      </p>
                      <span className="font-cormorant text-base text-[#D4AF37] tracking-wide mb-3">
                        {item.price}
                        {item.quantity > 1 && (
                          <span className="font-shaghafArabic text-[10px] text-white/25 mr-2">× {item.quantity}</span>
                        )}
                      </span>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          className="font-shaghafArabic text-[11px] tracking-[0.1em] text-[#C87D8A]/40 hover:text-[#C87D8A] transition-colors duration-300"
                        >
                          إلغاء
                        </button>
                        ...
                        <div className="flex flex-col items-end gap-1">
                          ...
                          {isOneOfOne && (
                            <span className="font-shaghafArabic text-[9px] tracking-[0.12em] text-[#D4AF37]/50">
                              قطعة فريدة لا تتكرر
                            </span>
                          )}
                        </div>
        ...
        {cart.length > 0 && (
          <div className="relative z-10 mt-auto border-t border-[#4B1E28]/60 p-6 bg-[#0A0A0A]">
            <div className="flex items-center justify-between mb-2">
              <span className="font-shaghafArabic text-[10px] tracking-[0.15em] text-white/20">شامل الضريبة</span>
              <div className="flex items-center gap-3">
                <span className="font-shaghafArabic text-[11px] tracking-[0.15em] text-white/35">المجموع الإجمالي</span>
            ...
            <p className="text-center font-shaghafArabic text-[9px] tracking-[0.2em] text-white/15 mt-4">

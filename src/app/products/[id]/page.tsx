...
function AccordionItem({ title, content }: { title: string; content: string }) {
  ...
  return (
    <div className="border-b border-white/[0.07]">
      ...
      >
        <span className="font-shaghafArabic text-sm tracking-[0.12em] text-white/70 group-hover:text-white transition-colors duration-300">
          {title}
        </span>
        <ChevronDown
      ...
      >
        <p className="font-shaghafArabic font-light text-sm text-white/40 leading-loose tracking-[0.1em]">
          {content}
        </p>
      </div>
    </div>
    ...
    <section className="max-w-6xl mx-auto px-6 py-20 border-t border-white/[0.05]" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-10 mb-14">
        ...
        <div className="flex-shrink-0">
          <span className="block font-shaghafArabic text-[9px] tracking-[0.4em] text-[#C87D8A]/50 mb-3">تقييمات العملاء</span>
          ...
          <div className="flex items-baseline gap-2 mb-2">
            ...
            <span className="font-shaghafArabic text-[11px] tracking-[0.2em] text-white/30">/ ٥ · {reviews.length} تقييم</span>
          </div>
        ...
        <div className="flex-1 flex flex-col gap-2 justify-center">
          {ratingCounts.map(({ n, count }) => (
            <div key={n} className="flex items-center gap-3">
              <span className="font-shaghafArabic text-[10px] tracking-wide text-white/30 w-4 text-center">{n}</span>
              ...
              <span className="font-shaghafArabic text-[10px] text-white/20 w-4 text-center">{count}</span>
            </div>
          ))}
        </div>
        ...
        <div className="flex-shrink-0 self-start">
          <button
            ...
            className="font-shaghafArabic text-[11px] tracking-[0.2em] text-[#D4AF37]/70 border border-[#D4AF37]/30 px-6 py-3 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all duration-300"
          >
      ...
      {showForm && (
        <div className="border border-white/[0.07] bg-white/[0.01] p-8 mb-10">
          ...
          <input
            ...
            className="w-full bg-transparent border-b border-white/[0.1] focus:border-[#D4AF37]/50 text-white/60 font-shaghafArabic text-sm py-2.5 mb-4 outline-none placeholder-white/20 tracking-[0.1em] transition-colors duration-300"
          />
          <textarea
            ...
            rows={3}
            className="w-full bg-transparent border-b border-white/[0.1] focus:border-[#D4AF37]/50 text-white/60 font-shaghafArabic text-sm py-2.5 mb-6 outline-none placeholder-white/20 tracking-[0.1em] resize-none transition-colors duration-300"
          />
          <button
            onClick={submitReview}
            className="font-shaghafArabic text-sm tracking-widest text-black bg-[#D4AF37] px-8 py-3 hover:bg-[#E5C158] transition-colors duration-300"
          >
            نشر الرأي
          </button>
        </div>
          ...
          >
            ...
            {review.image && (
              <div className="relative aspect-[16/7] overflow-hidden">
                ...
                <span className="absolute bottom-3 right-4 font-shaghafArabic text-[9px] tracking-[0.2em] text-white/50">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="font-shaghafArabic text-[9px] tracking-[0.15em] text-white/20">{review.date}</span>
              </div>

              {/* Quote */}
              <p className="font-shaghafArabic font-light text-sm text-white/55 leading-loose tracking-[0.08em] mb-5">
                {review.text}
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-shaghafArabic text-[11px] tracking-[0.15em] text-white/50">{review.author}</p>
                  <p className="font-shaghafArabic text-[9px] tracking-[0.1em] text-white/20">
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-white" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-6 pb-0">
        <nav className="flex items-center gap-2 font-shaghafArabic text-[10px] tracking-[0.2em] text-white/20">
      ...
      <div ref={sectionRef} className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 min-h-screen flex flex-col justify-center">
          ...
          >
            ...
            {/* Category label */}
            <span className="reveal-item inline-block self-start font-shaghafArabic text-[9px] tracking-[0.35em] text-[#C87D8A]/50 border border-[#C87D8A]/20 px-4 py-1.5 mb-6">
              {product.subtitle}
            </span>
            ...
            <div className="reveal-item flex items-center gap-4 mb-6">
              ...
              {product.oldPrice && (
                <>
                  <span className="font-shaghafArabic text-sm text-red-400/80 line-through tracking-wide">
                    {product.oldPrice}
                  </span>
                  <span className="font-shaghafArabic text-[10px] tracking-[0.15em] text-[#C87D8A]/70 bg-[#4B1E28]/30 border border-[#C87D8A]/20 px-2.5 py-1">
                    خصم حصري
                  </span>
                </>
              )}
            ...
            {/* Description */}
            <p className="reveal-item font-shaghafArabic font-light text-sm text-[#C87D8A]/70 leading-[2.2] tracking-[0.08em] max-w-sm mb-8">
              {product.description}
            </p>
            ...
            <div className="reveal-item mb-8">
              <div className="flex items-center justify-between mb-4">
                <span className="font-shaghafArabic text-sm tracking-[0.15em] text-white/70">
                  تدرجات اللون
                </span>
                <span className="font-shaghafArabic text-sm tracking-[0.1em] text-[#C87D8A]/80 font-medium">
                  {selectedColor.name}
                </span>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="reveal-item mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="font-shaghafArabic text-xs tracking-[0.1em] text-[#D4AF37]/60 hover:text-[#D4AF37]/90 transition-colors duration-300 underline underline-offset-2">
                  دليل المقاسات
                </button>
              </div>
              <div className="flex items-center flex-wrap gap-2">
                {sizes.map((size) => (
                  <button
                    ...
                    className={`font-shaghafArabic text-xs tracking-[0.1em] px-5 py-2.5 border transition-all duration-300 ${
                      selectedSize === size
            ...
            <div className="reveal-item mb-10">
              <span className="font-shaghafArabic text-sm tracking-[0.15em] text-white/70 block mb-4">
                الكمية
              </span>
              ...
              {[
                ...
                >
                  ...
                  <div className="text-center">
                    <p className="font-shaghafArabic text-[11px] tracking-[0.15em] text-[#C87D8A]/80">{label}</p>
                    <p className="font-shaghafArabic text-[9px] tracking-[0.1em] text-white/20 mt-0.5">{sub}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-white/[0.05]" dir="rtl">
        <div className="flex items-end justify-between mb-12">
          <div>
            <span className="block font-shaghafArabic text-[9px] tracking-[0.4em] text-[#C87D8A]/50 mb-3">من مجموعة شغف</span>
            <h2 className="font-cormorant font-semibold text-3xl text-white/80 tracking-wide">أكملي أناقتك</h2>
          </div>
          <Link href="/products" className="font-shaghafArabic text-[10px] tracking-[0.25em] text-white/25 hover:text-[#D4AF37]/60 transition-colors duration-500">
            عرض الكل ←
          </Link>
        </div>
            ...
            <Link key={item.id} href={`/products/${item.id}`} prefetch={false} className="group block">
              ...
              <div className="mt-4 px-1 flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="font-shaghafArabic text-[9px] text-white/30 tracking-[0.1em] mt-0.5">{item.subtitle}</p>
                </div>
                <span className="flex-shrink-0 font-shaghafArabic text-[10px] text-[#D4AF37] bg-[#4B1E28]/30 border border-[#D4AF37]/20 px-2.5 py-1 whitespace-nowrap">
                  {item.price}
                </span>
              </div>
            </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0A0A0A]/92 backdrop-blur-xl p-4 border-t border-[#D4AF37]/20 z-40 md:hidden">
        <div className="flex items-center gap-3">
          <div className="flex-1">
            ...
            <p className="font-shaghafArabic text-[10px] text-[#D4AF37]/60 tracking-[0.15em]">
              {product.price}
          ...
          >
            <span className="absolute inset-0 bg-[#D4AF37] translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out" />
            <span className="relative z-10 font-shaghafArabic font-medium text-[#D4AF37] group-hover:text-black transition-colors duration-500 text-[11px] tracking-widest whitespace-nowrap">
              إضافة للحقيبة
            </span>
          </button>
        </div>

    ...
    <Link href={`/products/${product.id}`} prefetch={false} className="product-card group block">
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-white/[0.03]">
        ...
        <div className="absolute top-4 right-4 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
          <span className="font-shaghafArabic text-[9px] tracking-[0.15em] text-SHAGHAV-gold bg-black/60 backdrop-blur-sm border border-SHAGHAV-gold/30 px-3 py-1">
            {product.subtitle}
          </span>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent pt-8 pb-4 px-4 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out">
          <span className="font-shaghafArabic text-[10px] tracking-[0.2em] text-white/70">
            استفسري عن القطعة ←
          </span>
        </div>
      </div>
      ...
      <div className="mt-4 px-1 flex items-start justify-between gap-2">
        <div>
          ...
          <p className="font-shaghafArabic text-[10px] text-white/30 tracking-[0.1em] mt-0.5">
            {product.subtitle}
          </p>
        </div>
        {/* Price – prominent gold pill */}
        <div className="flex-shrink-0 mt-0.5">
          <span className="font-shaghafArabic text-xs text-SHAGHAV-gold bg-[#4B1E28]/30 border border-[#D4AF37]/20 px-3 py-1 whitespace-nowrap">
            {product.price}
          </span>
        </div>
      </div>
  ...
  return (
    <main className="min-h-screen bg-[#050305] text-white selection:bg-SHAGHAV-gold selection:text-black" dir="rtl">
      ...
      <div className="relative pt-28 pb-12 px-6 text-center overflow-hidden">
        ...
        <span className="block font-shaghafArabic text-[9px] tracking-[0.5em] text-[#C87D8A] mb-5 uppercase">
          معرض شَغَف
        </span>
        <h1 className="font-cormorant font-semibold text-5xl md:text-7xl text-white tracking-wide">
          المُقتنيات
        </h1>
        <p className="font-shaghafArabic font-light text-xs text-white/35 tracking-[0.2em] mt-4 max-w-xs mx-auto leading-relaxed">
            ...
            {FILTERS.map(({ key, label }) => {
              ...
              return (
                <button key={key} onClick={() => changeFilter(key)}
                  className={`relative flex-shrink-0 font-shaghafArabic text-[11px] tracking-[0.12em] whitespace-nowrap px-5 py-4 transition-colors duration-500 ${isActive ? "text-SHAGHAV-gold" : "text-white/35 hover:text-white/65"}`}
                >
                  {label}
          ...
          <div className="flex items-center gap-3 py-3">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full bg-white/[0.04] border border-white/[0.08] text-white text-[11px] font-shaghafArabic tracking-[0.1em] placeholder-white/25 pr-9 pl-4 py-2.5 outline-none focus:border-SHAGHAV-gold/40 transition-colors duration-300"
              />
            </div>
            ...
            <select
              ...
              className="bg-white/[0.04] border border-white/[0.08] text-white/50 text-[10px] font-shaghafArabic tracking-[0.1em] px-3 py-2.5 outline-none focus:border-SHAGHAV-gold/40 transition-colors duration-300 cursor-pointer"
            >
            ...
            {/* Count badge */}
            <span className="flex-shrink-0 font-shaghafArabic text-[10px] text-white/25 tracking-[0.15em] hidden sm:block">
      ...
      <div ref={gridRef} className="max-w-7xl mx-auto px-4 md:px-8 pt-10 pb-32">
        {filtered.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-40 text-center">
            ...
            <p className="font-shaghafArabic text-[11px] text-white/20 tracking-[0.2em]">
      ...
      <div className="border-t border-white/[0.05] py-10 text-center">
        <p className="font-shaghafArabic text-[9px] text-white/15 tracking-[0.35em]">
          © شَغَف · كل قطعة تُروى قصتها بعنايةٍ واحترام
        </p>
        <Link href="/lobby" className="inline-block mt-3 font-shaghafArabic text-[9px] tracking-[0.3em] text-white/25 hover:text-SHAGHAV-gold/50 transition-colors duration-500">
          ← العودة للمعرض
        </Link>
      </div>
